...
function init_media_session()
{
	navigator.mediaSession.setActionHandler('previoustrack', () => {
		elem = document.getElementById("tracks_history").childNodes
		len = elem.length
		if (len > 2)
		{
			elem[len - 2].click()
...
function update_media_session(_artist, _song)
{
    ...
    album: "random",
    artwork: [
      { src: 'https://randommusic.insomnia247.nl/img/pic.jpg', sizes: '96x96',   type: 'image/png' },
      { src: 'https://randommusic.insomnia247.nl/img/pic.jpg', sizes: '128x128', type: 'image/png' },
      { src: 'https://randommusic.insomnia247.nl/img/pic.jpg', sizes: '192x192', type: 'image/png' },
      { src: 'https://randommusic.insomnia247.nl/img/pic.jpg', sizes: '256x256', type: 'image/png' },
      { src: 'https://randommusic.insomnia247.nl/img/pic.jpg', sizes: '384x384', type: 'image/png' },
      { src: 'https://randommusic.insomnia247.nl/img/pic.jpg', sizes: '512x512', type: 'image/png' },
    ]
  });
}
...
function PlayMusicByURL(URL)
{
	...
	update_media_session(tags.artist, tags.title)
